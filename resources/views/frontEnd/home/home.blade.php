...
@section('content')
    <div class="intro-slider-container mb-5">
        <div class="intro-slider owl-carousel owl-theme owl-nav-inside owl-light" data-toggle="owl"
            ...
            <div class="intro-slide" style="background-image: url({{ asset('frontendAsset') }}/assets/images/demos/demo-4/slider/slide-1.png);">
            ...
            <div class="intro-slide" style="background-image: url({{ asset('frontendAsset') }}/assets/images/demos/demo-4/slider/slide-2.png);">
                <div class="container intro-content">
                    <div class="row justify-content-end">
                        <div class="col-auto col-sm-7 col-md-6 col-lg-5">
            ...
            <div class="row">
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                                    <span>
                                        <img src="{{ asset('frontendAsset') }}/assets/images/demos/demo-4/cats/1.png" alt="Category image">
                                    </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                                    <span>
                                        <img src="{{ asset('frontendAsset') }}/assets/images/demos/demo-4/cats/2.png" alt="Category image">
                                    </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                                    <span>
                                        <img src="{{ asset('frontendAsset') }}/assets/images/demos/demo-4/cats/3.png" alt="Category image">
                                    </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                                    <span>
                                        <img src="{{ asset('frontendAsset') }}/assets/images/demos/demo-4/cats/4.png" alt="Category image">
                                    </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                                    <span>
                                        <img src="{{ asset('frontendAsset') }}/assets/images/demos/demo-4/cats/5.png" alt="Category image">
                                    </span>
                        </figure>
                ...
                <div class="col-6 col-sm-4 col-lg-2">
                    <a href="category.html" class="cat-block">
                        <figure>
                                    <span>
                                        <img src="{{ asset('frontendAsset') }}/assets/images/demos/demo-4/cats/6.png" alt="Category image">
                                    </span>
                        </figure>
        ...
        <div class="row justify-content-center">
            <div class="col-md-6 col-lg-4">
                <div class="banner banner-overlay banner-overlay-light">
                    <a href="#">
                        <img src="{{ asset('frontendAsset') }}/assets/images/demos/demo-4/banners/banner-1.png" alt="Banner">
                    </a>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="banner banner-overlay banner-overlay-light">
                    <a href="#">
                        <img src="{{ asset('frontendAsset') }}/assets/images/demos/demo-4/banners/banner-2.jpg" alt="Banner">
                    </a>
            ...
            <div class="col-md-6 col-lg-4">
                <div class="banner banner-overlay banner-overlay-light">
                    <a href="#">
                        <img src="{{ asset('frontendAsset') }}/assets/images/demos/demo-4/banners/banner-3.png" alt="Banner">
                    </a>
...
{{--                            <a href="product.html">--}}
                                <img src="{{ asset($new_arrival->image) }}" alt="Product image" class="product-image" style="height: 220px; width: 220px">
{{--                            </a>--}}
                            ...
                            <div class="product-action">
                                ...
                                <a href="{{route('details', ['id' => $new_arrival->id])}}" class="btn-product btn-quickview" title="Quick view"><span>quick view</span></a>
                            </div><!-- End .product-action -->
                        </figure><!-- End .product-media -->
                        <div class="product-body">
                           {{-- <div class="product-cat">
                                <a href="#" title="category">Laptops</a>
                            </div><!-- End .product-cat -->--}}
                            <h3 class="product-title"><a href="{{route('details', ['id' => $new_arrival->id])}}">{{$new_arrival->product_name}}</a></h3><!-- End .product-title -->
                            <div class="product-price">
                                <div><ins title="Selling Price">৳{{$new_arrival->selling_price}}</ins></div>
                                <hr>
                                <div><del title="Regular Price">৳{{$new_arrival->regular_price}}</del></div>
                ...
                <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl"
                    ...
                    <div class="product product-2">
                        <figure class="product-media">
                            ...
                            <a href="product.html">
                                <img src="{{ asset('frontendAsset') }}/assets/images/demos/demo-4/products/product-3.jpg" alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product product-2">
                        <figure class="product-media">
                            <a href="product.html">
                                <img src="{{ asset('frontendAsset') }}/assets/images/demos/demo-4/products/product-2.jpg" alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product product-2">
                        <figure class="product-media">
                            ...
                            <span class="product-label label-circle label-sale">Sale</span>
                            <a href="product.html">
                                <img src="{{ asset('frontendAsset') }}/assets/images/demos/demo-4/products/product-4.jpg" alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product product-2">
                        <figure class="product-media">
                            <span class="product-label label-circle label-top">Top</span>
                            <a href="product.html">
                                <img src="{{ asset('frontendAsset') }}/assets/images/demos/demo-4/products/product-5.jpg" alt="Product image" class="product-image">
                            </a>
                    ...
                    <div class="product product-2">
                        <figure class="product-media">
                            <span class="product-label label-circle label-top">Top</span>
                            <a href="product.html">
                                <img src="{{ asset('frontendAsset') }}/assets/images/demos/demo-4/products/product-1.jpg" alt="Product image" class="product-image">
                            </a>
    ...
    <div class="container">
        <div class="cta cta-border mb-5" style="background-image: url({{ asset('frontendAsset') }}/assets/images/demos/demo-4/bg-1.jpg);">
            <img src="{{ asset('frontendAsset') }}/assets/images/demos/demo-4/camera.png" alt="camera" class="cta-img">
            <div class="row justify-content-center">
                <div class="col-md-12">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6 deal-col">
                <div class="deal" style="background-image: url('{{ asset('frontendAsset') }}/assets/images/demos/demo-4/deal/bg-1.jpg');">
                    <div class="deal-top">
            ...
            <div class="col-lg-6 deal-col">
                <div class="deal" style="background-image: url('{{ asset('frontendAsset') }}/assets/images/demos/demo-4/deal/bg-2.jpg');">
                    <div class="deal-top">
    ...
    <div class="container">
        ...
        <div class="owl-carousel mt-5 mb-5 owl-simple" data-toggle="owl"
            ...
            <a href="" class="brand">
                <img src="{{ asset($brand->image) }}" alt="Brand Name" title="Brand">
            </a>
            @endforeach
        </div><!-- End .owl-carousel -->
        <hr>
    ...
    <div class="container for-you">
        <div class="heading heading-flex mb-3">
            <div class="heading-left">
                <h2 class="title">{{$home_category->category_name}}</h2><!-- End .title -->
            </div><!-- End .heading-left -->
        </div><!-- End .heading -->
        <div class="products">
            <div class="row justify-content-center">
...
{{--                            <span class="product-label label-circle label-sale">Sale</span>--}}
                            <a href="">
                                <img src="{{ asset($product->image) }}" alt="Product image" class="product-image" style="height: 325px; width: 275px">
                            </a>
                            ...
                            <div class="product-action">
                                <a href="#" class="btn-product btn-cart" title="Add to cart"><span>add to cart</span></a>
{{--                                <a href="{{route('details', ['id' => $product->id])}}" class="btn-product btn-quickview" title="Quick view"><span>quick view</span></a>--}}
                            </div><!-- End .product-action -->
                        </figure><!-- End .product-media -->
                        ...
                        <div class="product-body">
                            ...
                            <div class="product-price">
                                <span class="new-price" title="New Price">৳{{$product->selling_price}}</span>
                                <span class="old-price" title="Old Price"><del>৳{{$product->regular_price}}</del></span>
                            </div><!-- End .product-price -->
                        </div><!-- End lolo .product-body -->
                    </div><!-- End .product -->
    ...
    <div class="cta bg-image bg-dark pt-4 pb-5 mb-0" style="background-image: url({{ asset('frontendAsset') }}/assets/images/demos/demo-4/bg-5.jpg);">
        <div class="container">
            <div class="row justify-content-center">
