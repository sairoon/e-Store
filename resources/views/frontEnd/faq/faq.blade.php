...
@section('content')
    <main class="main">
        ...
        <div class="cta cta-display bg-image pt-4 pb-4" style="background-image: url({{ asset('frontendAsset') }}/assets/images/backgrounds/cta/bg-7.jpg);">
            <div class="container">
    ...
    <div class="text-center">
        <h5>Good service is our main priority</h5>
    </div>
    <hr>
@endsection
